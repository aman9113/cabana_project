    ...
    [354], {
        ...
        1557: (e, t, r) => {
            ...
            e.exports = function(e, t, r, v) {
                ...
                if (E) {
                    var w = E.prototype;
                    if (!m && o(w, "cause") && delete w.cause, !r) return E;
                    var I = n("Error"),
                        O = t((function(e, t) {
                            var r = f(v ? t : e, void 0),
                                n = v ? new E(e) : new E;
                            return void 0 !== r && i(n, "message", r), g && i(n, "stack", d(n.stack, 2)), this && s(w, this) && l(n, this, O), arguments.length > b && p(n, arguments[b]), n
                        }));
                    if (O.prototype = w, "Error" !== S ? a ? a(O, I) : u(O, I, {
                            name: !0
                        }) : h && y in E && (c(O, E, y), c(O, E, "prepareStackTrace")), u(O, E), !m) try {
                        w.name !== S && i(w, "name", S), w.constructor = O
                    } catch (e) {}
                    return O
                }
            }
