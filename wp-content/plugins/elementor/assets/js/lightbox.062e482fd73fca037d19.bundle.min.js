        ...
        3896: (e, t, s) => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                setVideoContent(e) {
                    ...
                    l.setMessage(n), this.setVideoAspectRatio();
                    const a = l.onHide;
                    l.onHide = function() {
                        a(), this.$buttons = jQuery(), this.focusedButton = null, l.getElements("message").removeClass("elementor-fit-aspect-ratio")
                    }
                },
                getShareLinks() {
                    const {
                    ...
                    }, s = jQuery, i = this.getSettings("classes"), o = this.getSettings("selectors"), l = s("<div>", {
                        class: i.slideshow.shareLinks
                    }), a = this.getSlide("active"), r = a.find(o.image), d = a.data("elementor-slideshow-video");
                    let c;
                    if (c = d || r.attr("src"), s.each(t, ((e, t) => {
                            const i = t.label,
                                n = s("<a>", {
                                    href: this.createShareLink(e, c, a.attr("e-action-hash")),
                                    target: "_blank"
                                }).text(i),
                                o = this.isFontIconSvgExperiment ? s(t.iconElement.element) : s("<i>", {
                                    class: "eicon-" + e
                                });
                            n.prepend(o), l.append(n)
                        })), !d) {
                        const t = this.isFontIconSvgExperiment ? s(n.downloadBold.element) : s("<i>", {
                            class: "eicon-download-bold"
                        });
                        t.attr("aria-label", e.download), l.append(s("<a>", {
                            href: c,
                            download: ""
                ...
                getSlideshowHeader() {
                    const {
                        i18n: e
                    } = elementorFrontend.config, t = jQuery, s = "yes" === elementorFrontend.getKitSettings("lightbox_enable_counter"), i = "yes" === elementorFrontend.getKitSettings("lightbox_enable_fullscreen"), o = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom"), l = "yes" === elementorFrontend.getKitSettings("lightbox_enable_share"), a = this.getSettings("classes"), r = a.slideshow, d = this.elements;
                    if (s || i || o || l) {
                        ...
                        if (o) {
                            ...
                            this.isFontIconSvgExperiment || (l.class = r.iconZoomIn), d.$iconZoom = t(s).attr(l).on("click", this.toggleZoomMode), i.push(d.$iconZoom), this.isFontIconSvgExperiment && (d.$iconZoomOut = t(n.zoomOutBold.element).attr(o).addClass(a.hidden).on("click", this.toggleZoomMode), i.push(d.$iconZoomOut)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                        if (i) {
                            ...
                            this.isFontIconSvgExperiment || (l.class = r.iconExpand), d.$iconExpand = t(s).append(t("<span>"), t("<span>")).attr(l).on("click", this.toggleFullscreen), i.push(d.$iconExpand), this.isFontIconSvgExperiment && (d.$iconMinimize = t(n.frameMinimize.element).attr(o).addClass(a.hidden).on("click", this.toggleFullscreen), i.push(d.$iconMinimize)), d.$header.append(i), this.$buttons = this.$buttons.add(i)
                        }
                ...
                setSlideshowContent(e) {
                    const {
                        i18n: t
                    } = elementorFrontend.config, s = jQuery, i = 1 === e.slides.length, o = "" !== elementorFrontend.getKitSettings("lightbox_title_src"), l = "" !== elementorFrontend.getKitSettings("lightbox_description_src"), a = o || l, r = this.getSettings("classes"), d = r.slideshow, c = s("<div>", {
                        class: d.container
                    }), h = s("<div>", {
                    ...
                    if (e.slides.forEach((e => {
                            ...
                            if (e.video) {
                                ...
                                const i = this.isFontIconSvgExperiment ? n.loading.element : "<i>",
                                    l = s("<div>", {
                                        class: r.playButton
                                    }).html(s(i).attr("aria-label", t.playVideo).addClass(r.playButtonIcon));
                                o.append(l)
                            } else {
                                const t = s("<div>", {
                        ...
                        m = s("<div>", {
                            ...
                            "aria-label": t.next
                        }).html(i), c.append(g, m), this.$buttons = this.$buttons.add(g).add(m)
                    }
                ...
                playSlideVideo() {
                    ...
                    let l, a;
                    i.append(n), e.append(i), -1 !== t.indexOf("vimeo.com") ? (l = "vimeo", a = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (l = "youtube", a = elementorFrontend.utils.youtube);
                    const r = a.getVideoIDFromURL(t);
                    a.onApiReady((e => {
                        "youtube" === l ? this.prepareYTVideo(e, r, i, n, o) : "vimeo" === l && this.prepareVimeoVideo(e, t, i, n, o)
                ...
                prepareYTVideo(e, t, s, i, n) {
                    ...
                    i.append(l), window.chrome && (a = e.PlayerState.UNSTARTED), s.addClass("elementor-loading " + o.invisible), this.player = new e.Player(l[0], {
                        videoId: t,
                        events: {
                            onReady: () => {
                ...
                prepareVimeoVideo(e, t, s, i, n) {
                    ...
                    this.player = new e.Player(i, l), this.player.ready().then((() => {
