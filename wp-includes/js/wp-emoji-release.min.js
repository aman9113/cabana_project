                ...
                return ("string" == typeof d ? function(d, a) {
                    return o(d, function(d) {
                        var u, f, c = d,
                            ...
                            b = a.callback(e, a);
                        if (e && b) {
                            for (f in c = "<img ".concat('class="', a.className, '" ', 'draggable="false" ', 'alt="', d, '"', ' src="', b, '"'), u = a.attributes(d, e)) u.hasOwnProperty(f) && 0 !== f.indexOf("on") && -1 === c.indexOf(" " + f + "=") && (c = c.concat(" ", f, '="', u[f].replace(t, n), '"'));
                            c = c.concat("/>")
                        }
                        return c
                    })
                    ...
                    var f, c, e, b, a, t, n, r, o, i, s, l = function d(u, f) {
                            var c, e, b = u.childNodes,
                                a = b.length;
                            for (; a--;) c = b[a], 3 === (e = c.nodeType) ? f.push(c) : 1 !== e || "ownerSVGElement" in c || h.test(c.nodeName.toLowerCase()) || d(c, f);
                            return f
                        }(d, []),
                        p = l.length;
                    for (; p--;) {
                        for (e = !1, b = document.createDocumentFragment(), a = l[p], t = a.nodeValue, n = 0; o = m.exec(t);) {
                            if ((s = o.index) !== n && b.appendChild(g(t.slice(n, s), !0)), o = o[0], i = x(o), n = s + o.length, s = u.callback(i, u), i && s) {
                                ...
                                r.className = u.className, r.alt = o, r.src = s, e = !0, b.appendChild(r)
                            }
                            r || b.appendChild(g(o, !1)), r = null
                        }
                        e && (n < t.length && b.appendChild(g(t.slice(n), !0)), a.parentNode.replaceChild(b, a))
                    }
                    return d
                })(d, {
